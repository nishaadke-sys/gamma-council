...
const DEFS = [
  {
    ...
    plain: "You hand me $10K today. Nothing happens yet. When I raise a real round from VCs, your $10K turns into shares. How good a deal you get depends on the valuation at that round. If VCs value Gamma at $10M and your cap was $3M, you convert as if it is still $3M - getting more than 3x the shares per dollar compared to the VCs. But if the VCs value the company at $2M (below your cap), the cap does not help - you just convert at $2M like everyone else. The cap only protects you when the valuation rises above it. In exchange, you receive ownership in the company when conversion happens. Three things can go wrong for you as an investor: if the next round valuation is at or below the cap, the cap does not help and you just convert at round price. If the company never raises a priced round, a SAFE sits indefinitely with no conversion and no repayment - your money is locked with no return path. A convertible note is slightly better here because it has a maturity date that forces a resolution. No loan to repay on a SAFE, no deadline, no interest.",
